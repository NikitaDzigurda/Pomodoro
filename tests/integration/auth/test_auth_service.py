...
from tests.fixtures.auth.client import EXISTS_GOOGLE_USER_ID, EXISTS_GOOGLE_USER_EMAIL
...
async def test_base_login__success(auth_service, get_db_session):
    ...
    user_data = await auth_service.login(password=password, username=username)
